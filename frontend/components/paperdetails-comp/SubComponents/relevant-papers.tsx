...
export default function RelavantPapers({results} : RelatedPapersLinkProps) {
  ...
  return (
    <div className="container mx-auto p-4 max-w-3xl">
      <h2 className="text-2xl font-bold mb-6">Papers from the web which are similar to this paper for deep dive: </h2>
          ...
          <>
            <li key={index} className="p-4 bg-card rounded-lg shadow">
              <div className="flex-grow mr-4">
                ...
                <p className="text-sm text-muted-foreground overflow-y-scroll max-h-12 p-2 bg-gray-100 rounded-xl my-3">{paper.description}</p>
              </div>
