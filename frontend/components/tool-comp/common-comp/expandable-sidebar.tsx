...
export function ExpandableSidebar() {
  ...
  return (
    <>
      <div
        className={`fixed sm:absolute z-10 left-0 top-0 m-[1vh] h-[98vh] bg-green-300/50 backdrop-blur-lg transition-all duration-300 ease-in-out rounded-lg shadow-lg ${
